...
class DB{
	function __construct(){
		      ...
		      $this->connection = mysql_connect(':/cloudsql/thinking-leaf-243001:us-central1:shipryt', 'antbusk', 'Window167764$') or die(mysql_error());
				mysql_select_db('shipryt', $this->connection) or die(mysql_error());
